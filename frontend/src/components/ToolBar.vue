<template>
    <div class="toolbar-container">
        ...
        <div class="toolbar-item" @click="selectTool('sam')"
            :class="{ 'selected': videoEditor.selectedToolIcon === 'sam' }">
            <div class="toolbar-item-icon-container">
                <i class="toolbar-item-icon fa-solid fa-s"></i>
            </div>
            <p class="toolbar-item-label">SAM</p>
        </div>
